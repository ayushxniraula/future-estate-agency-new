...
const content_data: ContentType = {
  ...
  desc_2: (
    <>
      Our dedicated risk and compliance consulting team assists clients in
      transforming uncertainty into advantageous prospects. We work
      collaboratively with organizations to identify & leverage the potential
      within their risk and compliance functions, enabling them to thrive in
      ever-changing business landscape.
    </>
  ),
  desc_3: (
    <>
      Your leading real estate advocate, transforming houses into dreams. Trust
      us to expertly guide you home.
    </>
  ),
  desc_4: (
    <>
      Our dedicated risk and compliance consulting team assists clients in
      transforming uncertainty into advantageous prospects.
    </>
  ),
  service_features: [
    {
      icon: "/assets/images/icon/icon_72.svg",
      title: "Property Insurance",
      desc: "Elit esse cillum dol fu nulla tur nos ullamo.",
    },
    {
      icon: "/assets/images/icon/icon_73.svg",
      title: "Easy Payments",
      desc: "quis nostr exerct ull security finibus ne derived.",
    },
    {
      icon: "/assets/images/icon/icon_74.svg",
      title: "Quick Process",
  ...
  service_list: [
    ...
    "Priority Access of exclusive sale",
  ],
  sidebar_list: [
    "Property & Loan",
    "Sell Home",
          ...
          <div className="col-lg-8">
            <div className="service-post">
                ...
                <div className="row">
                  <div className="col-8">
                    <img
                      ...
                      alt=""
                      className="lazy-img w-100 mt-20"
                    />
                  </div>
                  <div className="col-4">
                    <img
                      src="/assets/images/media/img_58.jpg"
                      alt=""
                      className="lazy-img w-100 mt-20"
                    />
                  </div>
                    ...
                    {service_features.map((item, index) => (
                      <div key={index} className="col-xl-4 col-lg-6 col-md-4">
                        <div className="card-style-eleven mt-30">
                          <div className="icon">
                            <img src={item.icon} alt="" className="lazy-img" />
                          </div>
              ...
              <ul className="list-style-one fs-22 color-dark style-none">
                {service_list.map((list, i) => (
                  <li key={i}>{list}</li>
                ))}
              </ul>
              <Link to="/contact" className="btn-two mt-30">
                Contact Us
              </Link>
            </div>
          </div>
