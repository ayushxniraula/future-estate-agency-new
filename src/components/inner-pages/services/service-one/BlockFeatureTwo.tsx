...
const BlockFeatureTwo = ({ style }: any) => {
  return (
    <div
      className={`block-feature-seventeen ${style ? "dark-bg" : "bg-pink-three"} position-relative z-1 pt-120 xl-pt-80 pb-140 xl-pb-80`}
    >
            ...
            <div className="title-one text-center mb-40 lg-mb-20">
              <h3 className={`${style ? "text-white" : ""}`}>
                ...
                <span>
                  Services
                  <img
                    src="/assets/images/shape/title_shape_07.svg"
                    alt=""
                    className="lazy-img"
                  />
                </span>
            ...
            .map((item) => (
              <div key={item.id} className="col-lg-4 col-md-6 d-flex mt-40">
                <div className="card-style-ten d-flex align-items-start flex-column w-100 h-100">
                  ...
                  <h6>{item.title}</h6>
                  <p>{item.desc}</p>
                  <Link to="/service_details" className="btn-twelve sm mt-auto">
                    {item.btn}
                  </Link>
                </div>
              </div>
      ...
      {style ? (
        <>
          <img
            src="/assets/images/shape/shape_75.svg"
            alt=""
            className="lazy-img shapes shape_01"
          />
          <img
            src="/assets/images/shape/shape_76.svg"
            alt=""
        ...
        <>
          <img
            src="/assets/images/shape/shape_73.svg"
            alt=""
            className="lazy-img shapes shape_01"
          />
          <img
            src="/assets/images/shape/shape_74.svg"
            alt=""
            className="lazy-img shapes shape_02"
          />
        </>
