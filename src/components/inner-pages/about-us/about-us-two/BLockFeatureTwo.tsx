...
const BLOCK_FEATURE_TWO_STYLES = `
  .fw-block-feature-two .bg-pink-two {
    background: rgba(28,148,164,0.07) !important;
  }
  .fw-block-feature-two .bg-pink-two .title-one h2 { color: #252060; }
  .fw-block-feature-two .bg-pink-two .title-one p { color: #5a5e7a; }

  .fw-block-feature-two .card-style-five {
    border-color: rgba(37,32,96,0.1);
    background: #fff;
  }
  .fw-block-feature-two .card-style-five:hover {
    border-color: #1C94A4;
    box-shadow: 0 10px 40px rgba(28,148,164,0.15);
  }
  .fw-block-feature-two .card-style-five h5 { color: #252060; }
  .fw-block-feature-two .card-style-five p { color: #5a5e7a; }
  .fw-block-feature-two .btn-twelve {
    background: #252060;
    border-color: #252060;
    color: #fff;
  }
  .fw-block-feature-two .btn-twelve:hover {
    background: #1C94A4;
    border-color: #1C94A4;
  }

  .fw-block-feature-two .block-feature-fourteen {
    background: linear-gradient(135deg, #252060 0%, #1a3a6b 60%, #1C94A4 100%);
  }
  .fw-block-feature-two .block-feature-fourteen .title-one h2 { color: #fff; }
  .fw-block-feature-two .block-feature-fourteen .card-style-eight h5 { color: #fff; }
  .fw-block-feature-two .block-feature-fourteen .card-style-eight p { color: rgba(255,255,255,0.75); }
  .fw-block-feature-two .block-feature-fourteen .card-style-eight {
    border-color: rgba(255,255,255,0.15);
  }
  .fw-block-feature-two .block-feature-fourteen .card-style-eight:hover {
    border-color: #1C94A4;
  }
`;

function injectBlockFeatureTwoStyles() {
  if (
    typeof document !== "undefined" &&
    !document.getElementById("fw-block-feature-two-styles")
  ) {
    const el = document.createElement("style");
    el.id = "fw-block-feature-two-styles";
    el.textContent = BLOCK_FEATURE_TWO_STYLES;
    document.head.appendChild(el);
  }
}

const BLockFeatureTwo = () => {
  injectBlockFeatureTwoStyles();
  return (
    <div className="fw-block-feature-two block-feature-sixteen">
      <div className="bg-pink-two position-relative z-1 pt-140 xl-pt-100 lg-pt-80 pb-150 xl-pb-120 lg-pb-100">
              ...
              .map((item) => (
                <div key={item.id} className="col-lg-4 col-md-6 mt-30 d-flex">
                  <div className="card-style-five text-center d-inline-flex flex-column align-items-center tran3s h-100 w-100">
                    ...
                    <Link to="/listing_10" className="btn-twelve mt-auto">
                      {item.btn}
                    </Link>
                  </div>
                </div>
        ...
        <img
          src="/assets/images/shape/shape_71.svg"
          alt=""
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-xxl-5 col-lg-6 ms-auto">
              <p className="text-white fs-24 m0 lh-lg">
