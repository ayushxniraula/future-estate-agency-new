...
const FutureCategory = ({ style }: any) => {
  return (
    <div
      className={`category-section-one ${style ? "grey-bg pt-130 pb-110 xl-pb-80" : "mt-65"}`}
    >
      <div className="container container-large">
        <div
          className={`position-relative z-1 ${style ? "" : "border-bottom pb-65 xl-pb-40"}`}
        >
          ...
          <div className="section-btn text-center sm-mt-40">
            <Link to="/listing_08" className="btn-eleven">
