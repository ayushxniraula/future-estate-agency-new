...
import HomeThree from "../pages/FutureHome";
...
import AboutUsTwo from "../pages/FutureAbout";
...
import ListingThirteen from "../pages/FutureBuy";
...
import ListingDetailsFour from "../pages/FutureSell";
...
import Contact from "../pages/FutureContact";
  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        <Route path="/futurehome" element={<FutureHome />} />
        ...
        <Route path="/about" element={<FutureAbout />} />
        ...
        <Route path="/contact" element={<FutureContact />} />
        ...
        <Route
          ...
          element={<DashboardPropertiesList />}
        />
        <Route
